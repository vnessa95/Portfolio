            ...
            <div className="AbtContainer">
                <NavBar />
                   ...
                   <div className="p">
                    ...
                    <div className="icons">
                    <i href="https://www.linkedin.com/in/vanessa-baker-b80237181/" id="fab" className="fab fa-linkedin-in fa-3x"></i>
                    <i href="https://www.instagram.com/thafloralyogi/" id="fab"  className="fab fa-instagram fa-3x"></i>
                    <i href="https://github.com/vnessa95" id="fab"  className="fab fa-github fa-3x"></i>
                    </div>
                    </div>
            </div>
        )
