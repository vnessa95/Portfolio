...
<p className="txt">Responsive JS Navbar</p>
...
<p className="txt">Wikipedia Redesign</p>
...
<p className="txt">Mock "Hackathon"</p>
...
<p className="txt">Voice Number Game</p>
...
<p className="txt">Yoga Products</p>
<i id="i" className="fab fa-react fa-2x"></i>
